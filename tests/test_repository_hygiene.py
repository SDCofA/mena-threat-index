...
METHODOLOGY_EVIDENCE = ["METHODOLOGY_REVIEW.md"]
...
def test_repository_hygiene_documentation_contract():
    ...
    assert "MENA Threat Index — an open, auditable geopolitical-risk index for the Middle East & North Africa, refreshed every 2 hours with forecasts and market correlations." in CONTRACT
    assert "lifecycle-active" in CONTRACT
    assert "https://sdcofa.github.io/mena-threat-index/" in CONTRACT
