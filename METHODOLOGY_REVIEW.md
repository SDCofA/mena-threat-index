...
| Event taxonomy & sourcing/bias context | Disaggregated event categories from media reports | **Raleigh et al. (2010)** ACLED; **Leetaru & Schrodt (2013)** Google News RSS; **Boschee et al. (2015)** ICEWS |
...
10. **Leetaru, K. & Schrodt, P. A. (2013).** "Google News RSS: Global Data on Events, Location and Tone, 1979–2012." ISA Annual Convention. http://data.gdeltproject.org/documentation/ISA.2013.Google News RSS.pdf — *Automated machine-coded global event extraction; sourcing-bias context.*
